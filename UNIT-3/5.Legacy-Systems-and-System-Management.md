...
Legacy Systems are older software systems that remain essential to business operations but depend on old / outdated hardware, software, programming languages, or operating systems.
...
2.  **Business Process Dependency:** Enterprise business processes have evolved to work around legacy software bugs and capabilities; replacing the software disrupts organizational operations.
3.  **Embedded Undocumented Business Rules:** Critical business rules (e.g., insurance risk assessment rules) exist _only_ inside the legacy code text and are un-documented elsewhere.
...
Software Re-engineering is the process of improving the internal structure and maintainability of existing software without significantly changing its external functionality.
