...
_(Based on Ian Sommerville, "Software Engineering" - Chapter 2)_
...
- **Preconditions & Postconditions:** Conditions that must be true before and after an activity is executed (e.g., _Precondition:_ Requirements document approved by client. _Postcondition:_ UML system models reviewed and signed off).
...
Incremental Development is a software development approach in which specification, development, and validation are interleaved, and the system is delivered as a series of functional increments.
...
The Spiral Model is a risk-driven software process model in which development proceeds through repeated loops, each including risk assessment and management activities.

### 5.2 Rational Unified Process (RUP)

Rational Unified Process (RUP) is a flexible, universal software process model that can be customized to resemble different software development models. It is described from three perspectives: Dynamic, Static, and Practice.

1.  **Dynamic Perspective (Phases over time):** Describes the four project phases: Inception, Elaboration, Construction, and Transition.
    - _Inception:_ Establish the business case.
    - _Elaboration:_ Develop system architecture and requirements.
    - _Construction:_ Implement and code the software.
    - _Transition:_ Deploy the system to the customer environment.
2.  **Static Perspective (Process Activities):** Shows the workflows (e.g., modeling, analysis, design).
3.  **Practice Perspective:** Recommends good software engineering practices, such as iterative development, requirements management, and visual modeling.
